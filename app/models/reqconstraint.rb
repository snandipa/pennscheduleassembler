class Reqconstraint < ActiveRecord::Base
    attr_accessible :user_id, :requirement_id, :course_rating_lb, :course_rating_ub, :instructor_rating_lb, :instructor_rating_ub, :difficulty_rating_lb, :difficulty_rating_ub
